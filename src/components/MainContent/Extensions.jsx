...
const CardBtn = () => (
  <button
    className={`bg-[var(--primary-blue-600)] text-[var(--neutral-grey-50)] hover:bg-transparent hover:text-[var(--primary-blue-600)] hover:outline-[var(--primary-blue-600)] hover:outline-2 cursor-pointer ${BtnStyle} w-full`}
  >
